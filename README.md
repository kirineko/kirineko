...
> ✨ **kirineko** — 美少女·白魔法程序喵，热爱 Web 世界里的一切，也热爱二次元。信仰是：**代码改变世界**。
...
- [《规格驱动开发：AI 时代软件开发新范式》](./papers/规格驱动开发：AI%20时代软件开发新范式.pdf) `Vibe Paper · 纯AI生成，未发表`
- 《云原生数据科学实验教学平台的设计与应用》（2026.02）
...
- 《一种订餐系统的保温箱的自动分配方法及系统》（2022）
- 《一种保温箱的开锁控制方法及系统》（2021）
